...
BEGIN
    ...
    DECLARE cur CURSOR FOR 
        ...
        FROM results WHERE r_year = 2022;
    ...
    read_loop: LOOP
        ...
        IF vote_share_var = (SELECT MAX(vote_share) FROM results WHERE consti_id = consti_id_var AND r_year = 2022) THEN
